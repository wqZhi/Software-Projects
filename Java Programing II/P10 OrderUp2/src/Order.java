...
public class Order implements Comparable<Order>{
   ...
   * @return 0 if two orders' prepTime are equal, or -1 if this order's prepTime is less than
   * another movie, or 1 if this order's prepTime is large than another movie
   *
   */
  @Override

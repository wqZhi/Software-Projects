...
public class Movie implements Comparable<Movie> {
    ...
    public Movie(int year, double rating, String name) {
        ...
        if (rating < 0.0 || rating > 10.0) {
            throw new IllegalArgumentException(
                "Invalid rate. The rate must be in the scale of 10.");
        }
     ...
     *
     * @return 0 if otherMovie has the same year, same rate, and same name as this movie;
     *         an integer less then 0 if this movie is older than the otherMovie,
     *         or if they were produced in the same year but this movie has a lower rating,
     *         or if they have the same year and same rating but this movie has a lower lexical
     *         order than otherMovie;

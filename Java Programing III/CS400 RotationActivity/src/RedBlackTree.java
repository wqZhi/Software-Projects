...
public class RedBlackTree<T extends Comparable<T>> implements SortedCollectionInterface<T> {
    ...
    private void rotate(Node<T> child, Node<T> parent) throws IllegalArgumentException {
        if (parent.leftChild.equals(child)) {//right rotation
        ...
        } else if (parent.rightChild.equals(child)) {//left rotation
...
// For the next two test methods, review your notes from 5.RBT Insert
    ...
    public void week05ActivityTestPart1() {
        ...
        rbt.rotate(rbt.root.leftChild.rightChild, rbt.root.leftChild);
        String afterRotate = "[4, 3, 7, 2, 6, 8, 1]";
        assertEquals(afterRotate, rbt.root.toString());
    }
    ...
    public void week05ActivityTestPart2() {
        ...
        String afterRotate = "[2, 1, 4, 3, 7, 6, 8]";
        assertEquals(afterRotate, rbt.root.toString());
    }
    ...
    public void week05ActivityTestPart3() {
        ...
        rbt.rotate(rbt.root.leftChild, rbt.root);
        expected = "[57, 41, 62]";
        assertEquals(expected, rbt.root.toString());

        rbt.insert(35);
        rbt.insert(70);
        expected = "[57, 41, 62, 35, 70]";
        assertEquals(expected, rbt.root.toString());

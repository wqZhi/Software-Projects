...
public class GamesConsole {
    ...
    /**
     * This method calls findAllGamesHelper() to find games in database and print the reorder result it in rating order (High - Low).
     *
    ...
    /**
     * This method is to find a given name and search it in the list by using hashtable function, which is get();
     *
     * @param name the name of the game
    ...
    /**
     * This method is for dealing with multi-criteria search. Take two user's inputs, which is a rating and a tag.
     * Then find games with these characteristics and print out.
     *
     * @param rating the rating of the game
    ...
    /**
     * This method will help sort the rating list from (high to low).
     * If the two games have the same rating number, it will sort base on the its alphabet (A-Z) order.
     *
    ...
    public void printGameInfo(Game game) {
        String gameInfo = "Game Name: " + game.getName()
                + " --> Tag: " + game.getTag()

...
/**
 * This class is an front-end, interact with the user.
 */
public class Main {
        ...
        do {
            ...
            switch (userCommand) {
                ...
                case (3):
                    ...
                    System.out.println("> Please choose one tag and enter its serial number (1 - 4) " +
                            "[also accept 01 refer to ACTION, etc] :");
                    console.printTags();
    ...
    /**
     * This method is to check user's input validity.
     *
     * @param userCommand user's input
     * @param min minimum range
     * @param max maximum range
     * @param scnr Scanner object
     *
     * @return an integer that meet the validity of choice.
     */

...
class Object1 extends GrObject {
  constructor() {
    ...
    geometry.vertices.push(new T.Vector3(0, 1, 0));//1 -y
    geometry.vertices.push(new T.Vector3(1, 0, 0));//2 -x
    geometry.vertices.push(new T.Vector4(0, 0, 1));//3 -z
    //
    let f1 = new Geom.Face3(1, 3, 2);
    f1.color.setStyle("red");
    geometry.faces.push(f1);
    
    let f2 = new Geom.Face3(1, 0, 3);
    f2.color.setStyle("yellow");
    geometry.faces.push(f2);

    let f3 = new Geom.Face3(1, 2, 0);
...
class Object3 extends GrObject {
  constructor() {
    let geometry = new Geom.Geometry();
    //
    geometry.vertices.push(new T.Vector3(0, 0, 1));//-z
    geometry.vertices.push(new T.Vector3(1, 0, 0));//x
    geometry.vertices.push(new T.Vector3(0, 1, 0));//y
    geometry.vertices.push(new T.Vector3(-1, 0, 0));//-x
    //
    let f1 = new Geom.Face3(0, 1, 2);
    f1.color.setStyle("yellow");
    f1.vertexNormals[0] = new T.Vector3(0, s2, s2);
    f1.vertexNormals[1] = new T.Vector3(s2, 0, s2);
    f1.vertexNormals[2] = new T.Vector3(0, s2, -s2);
    geometry.faces.push(f1);
    //
    let f2 = new Geom.Face3(0, 2, 3);
    f2.color.setStyle("yellow");
    f2.vertexNormals[0] = new T.Vector3(0, s2, s2);
    f2.vertexNormals[1] = new T.Vector3(0, s2, -s2);
    ...
    f3.vertexNormals[2] = new T.Vector3(0, s2, -s2);
    geometry.faces.push(f3);

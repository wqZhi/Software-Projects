...
/**
 * This is a unit test, using JUnit.
 */
public class UnitTests {
    ...
    public void testGameExist() {
        ...
        String expectDescription =
                "Call of Duty: Advanced Warfare envisions the powerful battlegrounds of "
    ...
    public void testFindSpecifiedName() {
        ...
        String expectDescription =
                "Age of Empires II: Definitive Edition celebrates the 20th anniversary of one of "
    ...
    public void testMultiCriteriaSearch() {
        ...
        double expectPrice = 19.99;
        String expectDescription =
                "Dead by Daylight is an action-survival multiplayer game in which a killer hunts"

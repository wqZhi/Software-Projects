...
//int thread_create routine should call malloc() to create a new user stack.
//calls malloc to allocate memory for the stack. and then pass it into the clone function call.
